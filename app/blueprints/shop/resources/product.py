...
class UploadImage(Resource):
    def post(self):
        ...
        image_file.save(
            os.path.join(os.getcwd(), "app", "static", "uploads", image_file.filename)
        )
...
class ProductResource(Resource):
    ...
    def post(self):
        ...
        context = {"status": True, "content": data_schema.dump(new_product)}
    ...
    def put(self, id):
        ...
        context = {"status": True, "content": data_schema.dump(upd_product)}
    ...
    def delete(self, id):
        ...
        context = {"status": True, "content": "registro eliminado"}
